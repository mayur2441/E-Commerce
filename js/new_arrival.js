...
const container = document.getElementById("newArrival");
const newArrivalProducts = getRandomProducts(ALL_PRODUCTS, 6);
newArrivalProducts.forEach(product => {
    container.innerHTML += `
        <div class="col-md-3 mb-4 d-flex">
                    <div class="card h-100 w-100 product-card">
                        <!-- Badges -->
                        <span class="badge bg-primary position-absolute top-0 start-0 m-2 px-2 py-1 small fw-semibold">
                            New Arrival
                        </span>

                        <!-- Image -->
                        <div class="img-wrapper">
                            <img src="${product.mainImage}" class="card-img-top object-fit-cover"
                                style="height: 200px;" alt="Product 2">
                        </div>
